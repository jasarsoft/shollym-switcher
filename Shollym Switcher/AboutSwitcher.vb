Public NotInheritable Class AboutSwitcher
    ...
    Private Structure Info
        ...
        Public Const VERSION As String = "1.1 Beta"
        Public Const LICENSE As String = "Apache License v2.0"
        Public Const WEBSITE As String = "https://github.com/jasarsoft/shollym-switcher"
        Public Const DEVELOPER As String = "Edin Jašarević"
        Public Const COPYRIGHT As String = "2016 November - 2017 August"
